## 20-10-2025: create lookup at oa11 to msoa11, get the estimates, and then aggregate up to lsoa21, could be a way to solve the issue of there being missing lsoa21s. Although...would also need to do some version of this with births, etc. 
...
mye_net_11 <- readRDS("input_data/intermediate/msoa11_flows.rds")
  ...
  ### 1.3. msoa and lsoa 2011 population (using midyear for this and not census. TO DISCUSS - is this right?). Wait. Written on 21/10/2025. Why do I use the rebased 2021 lsoa boundaries one here? I shouldn't. This is creating a distortion. It should be just be the sape 2011 series released shortly after the census was taken, right? 
